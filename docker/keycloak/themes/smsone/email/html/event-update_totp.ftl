...
<head>
  ...
  <title>Security Alert: Authenticator Updated - ${realmName!'SMSOne'}</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;line-height:1.2;color:#1e293b;text-align:center;">
                Security Alert: Authenticator Updated
              </h1>
              ...
              <p style="margin:0 0 24px;font-size:16px;line-height:1.6;color:#334155;text-align:center;">
                This is a courtesy notification that the <strong>Authenticator App (OTP)</strong> was recently updated or added to your account on the <strong>${realmName}</strong> portal.
              </p>
              ...
              <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#dc2626;text-align:center;font-weight:500;">
                If you did not perform this action, your account may be compromised. Please contact your system administrator immediately.
              </p>
