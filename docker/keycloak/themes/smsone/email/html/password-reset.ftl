<#--
  ...
  Sent by Keycloak when a user hits "Forgot password" on the login
  page (or when an admin triggers a reset action via the Admin REST
  API). linkExpiration is in raw minutes; we render hours/minutes so
          ...
          <tr>
            <td style="padding:28px 32px 0 32px;">
              <table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="background:#0f172a;border-radius:6px;">
                <a href="${link}" style="display:inline-block;padding:11px 22px;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:-0.1px;">Reset password →</a>
              </td></tr></table>
          ...
          <tr>
            <td style="padding:24px 32px 0 32px;">
              <div style="padding:14px 16px;border:1px solid #e5e7eb;border-radius:6px;background:#fafaf9;font-size:12px;line-height:1.55;color:#737373;">
                ...
                If you didn&rsquo;t ask to reset your password, you can safely ignore this email — your current password still works.
              </div>
            </td>
          </tr>
