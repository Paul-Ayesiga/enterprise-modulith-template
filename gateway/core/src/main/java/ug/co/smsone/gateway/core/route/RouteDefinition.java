 ...
 * priority, its coarse {@link AuthPolicy}, its {@link TrafficPolicy}, its {@link TransformPolicy}, its
 * {@link LifecyclePolicy}, and free-form metadata. The runtime (gateway-app) translates this into its
 * own route table; the core never depends on that runtime, so the same definition could drive a different one.
 */
public record RouteDefinition(
    ...
    public RouteDefinition {
        ...
        lifecycle = lifecycle == null ? LifecyclePolicy.PUBLISHED : lifecycle;
    }
}
