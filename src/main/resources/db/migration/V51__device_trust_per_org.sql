...
-- triple could express that this pair cannot.
--
...
-- The FK to user_device is REAL and inside this module (access owns both tables), so a hard-deleted
-- device cannot leave its grants behind. org_id is a soft ref for the usual reason: this modulith is
