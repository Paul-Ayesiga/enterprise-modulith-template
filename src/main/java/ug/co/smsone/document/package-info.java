 ...
 * the {@code Documents} port). Deletion is asymmetric by design: the object goes immediately, the
 * row soft-remains as the metadata trail. Titles are pushed into the search projection on register
 * and removed on delete — the reference producer for the {@code SearchIndex} port.
 */
