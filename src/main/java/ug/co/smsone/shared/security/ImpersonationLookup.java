...
public interface ImpersonationLookup {
    ...
    /**
     * The live session with this id that was opened <em>by this actor</em> — empty when the id is
     ...
     * a header, read off a log line — usable by whoever holds it; pinning it to the actor's own
     * subject means a stolen id grants its thief nothing.
     *
     ...
     */
    Optional<ImpersonatedPrincipal> activeSession(String sessionId, String actorSubject);
}
