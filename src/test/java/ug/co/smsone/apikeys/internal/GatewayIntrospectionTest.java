...
class GatewayIntrospectionTest extends AbstractIntegrationTest {
    ...
    private RequestPostProcessor seedMember(UUID orgId, String label, String... permissions) {
        ...
        // so it takes one span on this organization's axis. The introspection path itself needs none:
        // `api_key` is platform-tier and ApiKeyAuthenticationFilter declares that axis for the probe,
        // because the key is HOW the tenant is discovered.
