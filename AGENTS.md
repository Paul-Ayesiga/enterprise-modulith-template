...
| `SoftDeletableEntity` | + `deleted_at`, `markDeleted`, `restore` | aggregate roots whose deletion must be recorded | `Organization`, `Membership`, `Role`, `Setting`, `FeatureFlag`, `User`, `WebhookSubscription` |
